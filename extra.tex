...
\noi $15.$ Construct two covering maps $f\:X\to Y$ and $g\:Y\to Z$ such that the composition $gf\:X\to Z$ is not a covering map.

\ 

\noi $16.$ Construct a finite topological space with fundamental group isomorphic to~$\ZZ_2$.
